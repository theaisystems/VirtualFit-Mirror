...
sys.path.append(r'E:\AsadHussain\tryon')
...
def build_args():
    ...
    parser.add_argument("--model_load_path", default=r"E:\AsadHussain\Viton_checkpoint\VITONHD.ckpt", type=str)
...
def main(args):
    ...
    model = model.cuda() #!!! back to cuda when required
    model.eval()
